...
window.DECK = {
  ...
  pages: {
    samsung: {
      ...
      marks: {
        ...
        core: [[90, 3170, 820, 560], [1180, 3160, 520, 650], [980, 4090, 860, 900]],
    ...
    acer: {
      ...
      bands: [['Branding', 109, 696], ['Scenario', 805, 789], ['Core experience', 1594, 618], ['Product details', 2212, 847], ['Selling', 3059, 838], ['FAQ', 3897, 409]],
      marks: {
  ...
  regions: {
    ...
    acer: {
      ...
      details: { spot: [0, 2212, 1440, 847], focus: [0, 2380, 1440, 640] },
      selling: { spot: [0, 3059, 1440, 838], focus: [0, 3120, 1440, 740] },
      product: { spot: [0, 2212, 1440, 1685], focus: [0, 2380, 1440, 1480] },
    },
  },
  ...
  steps: d => {
    ...
    return [
      ...
      d.zoom(1, REF, 'branding', { callout: { k: 'SAMSUNG · BRANDING', h: '以新機為主角的<br>品牌宣言', tag: '產品導向',
        items: [[1, '大標 <strong>Galaxy AI. Make life more seamless.</strong> 直接定義 AI'], [2, '主視覺是 <strong>Galaxy Z Fold8 新機照</strong>，品牌＝硬體'], [0, '第一屏<strong>看不到 AI 實際在做什麼</strong>']] } }),
      d.overview(1, SUBJECT, 'branding', { active: ['Branding'], thumb: thumb('branding'),
        caption: { k: 'ACER AIS MOCKUP', h: '同樣從品牌露出開始，<br>但目的不同', p: '要讓人好奇「電腦能做什麼」，自然往下看情境。' } }),
      d.zoom(1, SUBJECT, 'branding', { thumb: thumb('branding'), callout: { k: 'ACER AIS · BRANDING', h: '用一句提問，<br>帶出真實 AI 介面', tag: '體驗導向',
        items: [[1, '問句宣言 <strong>CAN YOUR COMPUTER DO THAT?</strong> 引發好奇'], [2, '主視覺直接呈現 <strong>AIS 真實介面</strong>：Meeting Assistant、AI Workspace'], [3, '關鍵字預告情境 <strong>會議記錄・本機生圖・遊戲片段</strong>，銜接下一段 Scenario']] } }),
      ...
      d.zoom(3, SUBJECT, 'core', { thumb: thumb('core'), message: 'qubi', callout: { k: 'ACER AIS · CORE EXPERIENCE', h: '把核心概念具象化', tag: '概念具象化',
      ...
      d.versus(3, [REF, 'core'], [SUBJECT, 'core'], `<h3>從「一組功能」到「<em>一個看得見的夥伴</em>」</h3>` +
        versusTable([['呈現方式', '助理＋安全分段說明', '單一角色 Qubi and Qubi Claw'], ['用戶要記住的', '多個功能名稱', '一個核心概念'], ['在頁面中的角色', '功能補充', '串連情境與硬體']])),
      ...
      d.zoom(4, REF, 'selling', { callout: { k: 'SAMSUNG · SELLING', h: '試用推廣＋機型列表，<br>FAQ 另外補充', tag: '停在感受層',
        items: [[1, '<strong>Try Galaxy</strong> 推廣：導向試用 App 與下載'], [2, '依<strong>裝置類型</strong>分頁：Smartphones、Tablets、Watches、Buds'], [3, '機型卡只有<strong>圖＋Learn more</strong>，沒有功能對照'], [4, '<strong>FAQ</strong> 補足說明與 SEO']] } }),
      d.overview(4, SUBJECT, 'product', { active: ['Product details', 'Selling'], thumb: thumb('selling'),
        caption: { k: 'ACER AIS MOCKUP', h: 'Acer 用兩個區塊<br>完成導購', p: '先回答「哪一台跑得動」，再「找到你的搭檔」。' } }),
      d.zoom(4, SUBJECT, 'details', { thumb: thumb('selling'), callout: { k: 'ACER AIS · PRODUCT DETAILS', h: '功能表：<br>哪一台跑得動', tag: '功能 × 機型',
        items: [[1, '<strong>情境切換</strong>：商務、創意、遊戲'], [2, '<strong>功能 × 機型對照表</strong>，把硬體賣點藏進功能表裡講'], [3, '推薦機型<strong>整欄標示</strong>，一眼看出最適合的一台']] } }),
      d.zoom(4, SUBJECT, 'selling', { thumb: thumb('selling'), callout: { k: 'ACER AIS · SELLING', h: '找到你的<br>AI 搭檔', tag: '每種需求都有 CTA',
        items: [[1, '<strong>首選機型</strong>：綠框＋看規格與購買'], [2, '第二推薦與跨裝置體驗，<strong>點擊導往商城</strong>查看細節'], [3, '已有 Acer 電腦 → <strong>下載 Acer Intelligence Space</strong>']] } }),
